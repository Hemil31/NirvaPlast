                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="blog_heading" class="form-control" id="blog_heading"
                                            placeholder="Enter Blog Heading" value="{{ old('blog_heading') }}" />
                                        @error('blog_heading')
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" class="form-control" id="blog_content" rows="5" placeholder="Enter Blog Content">{{ old('content') }}</textarea>
                                        @error('content')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
