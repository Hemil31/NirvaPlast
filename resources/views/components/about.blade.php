    ...
    <div class="container pb-5">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-0">
                    <div class="col-6">
                        <img class="img-fluid" src="{{ asset('front/img/about-1.jpg') }}">
                    </div>
                    <div class="col-6">
                        <img class="img-fluid" src="{{ asset('front/img/about-2.jpg') }}">
                    </div>
                    <div class="col-6">
                        <img class="img-fluid" src="{{ asset('front/img/about-3.jpg') }}">
                    </div>
                    <div class="col-6">
                        <div
